                ...
                > 
                    <div className="flex-col  h-auto ">
                        ...
                        {cartList.map((product) => (
                            <div key={product.ProductId}className=" flex items-center mb-1 py-2 px-2 transition duration-300 ease bg-blue-200 hover:bg-gray-200 transform hover:-translate-y-1 hover:scale-110 ...">
